...
local function CreateIconResizeWidgets()
	...
	-- Remove SetStepsPerPage and SetObeyStepOnDrag - not available in 3.3.5a
	...
	_G[ "ItemTooltipIconsConfigSlider0Low" ]:SetText( "8" )
	_G[ "ItemTooltipIconsConfigSlider0High" ]:SetText( "32" )
