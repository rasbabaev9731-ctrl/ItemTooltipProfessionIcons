...
-- For WotLK 3.3.5a compatibility - use correct texture paths
ItemProfConstants.PROF_TEXTURES = {
[ COOK ] = "Interface\\Icons\\INV_Misc_Food_15",  -- Cooking
[ FAID ] = "Interface\\Icons\\Spell_Holy_SealOfSacrifice",  -- First Aid
[ ALC ] = "Interface\\Icons\\Trade_Alchemy",  -- Alchemy
[ BS ] = "Interface\\Icons\\Trade_BlackSmithing",  -- Blacksmithing
[ ENC ] = "Interface\\Icons\\Trade_Engraving",  -- Enchanting
[ ENG ] = "Interface\\Icons\\Trade_Engineering",  -- Engineering
[ LW ] = "Interface\\Icons\\INV_Misc_Pelt_Wolf_01",  -- Leatherworking
[ TAIL ] = "Interface\\Icons\\Trade_Tailoring",  -- Tailoring
[ JC ] = "Interface\\Icons\\INV_Misc_Gem_01",  -- Jewelcrafting
[ INS ] = "Interface\\Icons\\INV_Inscription_Tradeskill01",  -- Inscription
[ Q ] = "Interface\\GossipFrame\\AvailableQuestIcon",
[ DMF ] = "Interface\\Icons\\INV_Misc_Ticket_Tarot_Madness_01"  -- Darkmoon Faire
}
...
-- Debug function
function ItemProfConstants:DebugItem(itemID)
    local flags = self.ITEM_PROF_FLAGS[itemID]
    if flags then
        DEFAULT_CHAT_FRAME:AddMessage("Item " .. itemID .. " has flags: " .. flags)
    else
        DEFAULT_CHAT_FRAME:AddMessage("Item " .. itemID .. " not found in database")
    end
    return flags
end